...
| Key | Value |
|---|---|
| MS4_SECRET_KEY | ## YOUR SECRET_KEY ## |
| DATABASE_URL | ## YOUR DATABASE_URL ## |
| STRIPE_PUBLIC_KEY | ## YOUR STRIPE_PUBLIC_KEY ## |
| STRIPE_SECRET_KEY | ## YOUR STRIPE_SECRET_KEY ## |
| MS4_STRIPE_WH_SECRET | ## YOUR STRIPE_WH_SECRET ## |
| MS4_EMAIL_HOST_USER | ## YOUR EMAIL ADDRESS ## |
| MS4_EMAIL_HOST_PASS | ## YOUR EMAIL APP PASS CODE ## |
...
os.environ["MS4_SECRET_KEY"] = "## YOUR SECRET_KEY ##"
...
os.environ["MS4_STRIPE_WH_SECRET"] = "## YOUR STRIPE_WH_SECRET ##"
os.environ["MS4_EMAIL_HOST_USER"] = "## YOUR EMAIL ADDRESS ##"
os.environ["MS4_EMAIL_HOST_PASS"] = "## YOUR EMAIL APP PASS CODE ##"
...
* MS4_SECRET_KEY: This is a custom string set up to keep sessions secure. I recommend using a 'Fork Knox' level password generated by [RandomKeygen](https://randomkeygen.com/).
...
* MS4_STRIPE_WH_SECRET: In the Developer's Webhooks section after creating an endpoint for your webhook - Signing secret.
* MS4_EMAIL_HOST_USER: Your email address or username. [See below for instructions](#email-setup).
* MS4_EMAIL_HOST_PASS: Your passcode from your email client. [See below for instructions](#email-setup).
...
16. Install the Heroku CLI and log in using `heroku login -i`.
17. Run `heroku config:set DISABLE_COLLECTSTATIC=1 --app ci-ms4-cpb-shop`.
...
21. If you'd like to automatically deploy to Heroku whenever you push to GitHub, do the following:
    ...
    * In '**Manual Deploy**', choose which branch you'd like to deploy from (I chose '**main**' branch, this used to be '**master**').
...
2. On GitHub, go to [tubaman48/ci-ms4-cpb-shop](https://github.com/tubaman48/ci-ms4-cpb-shop).
...
1. Clone from GitHub
    * Log in to [GitHub](https://www.github.com) and locate the [Repository](https://github.com/tubaman48/ci-ms4-cpb-shop) for this site.
