"""
Django settings for cpb_shop project.
...
DEBUG = 'MS4_DEVELOPMENT' in os.environ

ALLOWED_HOSTS = ['ci-ms4-cpb-shop.herokuapp.com', 'localhost']
...
WSGI_APPLICATION = 'cpb_shop.wsgi.application'
...
if 'USE_AWS' in os.environ:
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'tubaman48-cpb-shop'
